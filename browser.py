"""
AKARI Browser — Playwright-based web browsing capabilities.
...
log = logging.getLogger("akari.browser")
...
class AkariBrowser:
    """Playwright-based web browsing for AKARI."""
    ...
    async def _ensure_browser(self):
        ...
        # Launch VISIBLE browser so user can watch AKARI browse
    ...
    async def screenshot(self, url: str, path: str = None) -> str:
        ...
        try:
            ...
            if not path:
                tmp = tempfile.mktemp(suffix=".png", prefix="akari_screenshot_")
                path = tmp
