"""
AKARI Dispatch Registry — tracks all active and recent project builds/dispatches.

Persists to SQLite so AKARI always knows what he's working on,
...
log = logging.getLogger("akari.dispatch")
